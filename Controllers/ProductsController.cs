...
namespace TruckApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Product>>> GetProductsCategories(int id)
        {
        ...
        [HttpGet("supliers/{id}")]
        public async Task<ActionResult<IEnumerable<Product>>> GetProductsSupliers(int id)
        {
